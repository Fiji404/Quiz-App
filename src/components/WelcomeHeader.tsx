            ...
            {!isQuizStarted && (
                <header className="mt-6 py-4 px-2">
                    <h1 className="text-center text-4xl font-extrabold opacity-0 -translate-y-full animate-originate">
                        Welcome to <span className="text-[# 4DAAF7]">quizzy</span>, place for improve
                        knowledge of any topic
                    </h1>
                    <p className="text-center font-medium text-[#3b3b3b] opacity-0 animate-[originate_1s_500ms_forwards]">
                        Pick your quiz below
                    </p>
                </header>
            )}
        </>
